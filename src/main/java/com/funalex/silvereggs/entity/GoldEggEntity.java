...
public class GoldEggEntity extends ThrownItemEntity {
    public GoldEggEntity(EntityType<? extends GoldEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public GoldEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public GoldEggEntity(World world, double x, double y, double z) {
