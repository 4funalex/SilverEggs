...
public class CoalEggEntity extends ThrownItemEntity {
    public CoalEggEntity(EntityType<? extends CoalEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public CoalEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public CoalEggEntity(World world, double x, double y, double z) {
