...
public class NetherEggEntity extends ThrownItemEntity {
    public NetherEggEntity(EntityType<? extends NetherEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public NetherEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public NetherEggEntity(World world, double x, double y, double z) {
