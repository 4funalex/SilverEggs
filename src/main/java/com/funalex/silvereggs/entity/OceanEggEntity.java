...
public class OceanEggEntity extends ThrownItemEntity {
    public OceanEggEntity(EntityType<? extends OceanEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public OceanEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public OceanEggEntity(World world, double x, double y, double z) {
