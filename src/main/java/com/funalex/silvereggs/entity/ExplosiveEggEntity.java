...
public class ExplosiveEggEntity extends ThrownItemEntity {
    public ExplosiveEggEntity(EntityType<? extends ExplosiveEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public ExplosiveEggEntity(World world, LivingEntity owner) {
