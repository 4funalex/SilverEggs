...
public class MysteryEggEntity extends ThrownItemEntity {
    public MysteryEggEntity(EntityType<? extends MysteryEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public MysteryEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public MysteryEggEntity(World world, double x, double y, double z) {
