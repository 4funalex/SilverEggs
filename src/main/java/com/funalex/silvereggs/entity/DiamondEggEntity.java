...
public class DiamondEggEntity extends ThrownItemEntity {
    public DiamondEggEntity(EntityType<? extends DiamondEggEntity> entityType, World world) {
    ...
    public DiamondEggEntity(World world, double x, double y, double z) {
