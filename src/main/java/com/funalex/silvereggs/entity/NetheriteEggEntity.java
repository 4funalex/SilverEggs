...
public class NetheriteEggEntity extends ThrownItemEntity {
    public NetheriteEggEntity(EntityType<? extends NetheriteEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public NetheriteEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public NetheriteEggEntity(World world, double x, double y, double z) {
