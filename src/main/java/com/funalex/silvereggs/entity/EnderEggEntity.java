...
public class EnderEggEntity extends ThrownItemEntity {
    public EnderEggEntity(EntityType<? extends EnderEggEntity> entityType, World world) {
        super(entityType, world);
    }

    public EnderEggEntity(World world, LivingEntity owner) {
        super(EntityRegistry.EXPLOSIVE_EGG_ENTITY_ENTITY_TYPE, owner, world);
    }

    public EnderEggEntity(World world, double x, double y, double z) {
